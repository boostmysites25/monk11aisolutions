        ...
        <div className="pt-[12rem] pb-[5rem]">
          <div className="wrapper flex flex-col gap-7 justify-center h-full">
            ...
            <h1 data-aos="fade-up" className="heading !text-white">
              Welcome to{" "}
              <span className="gradient-text">Monk 11 AI Solutions – </span>
              <br />
            ...
            >
              {bannerServices.map((item) => (
                <div
                  key={item.id}
                  className="p-5 rounded-xl lg:hover:bg-primary backdrop-blur-md bg-primary/60 text-white space-y-4 transition-all duration-300"
                >
